...
*       basemin(j)      = Stores the value for the minimum flux of reaction j in base
*       basemax(j)      = Stores the value for the maximum flux of reaction j in base
*       phenomin(j)     = Stored the value for the minimum flux of reaction j in target
*       phenomax(j)     = Stores the value for the maximum flux of reaction j in target
...
***********     dual1 = Dual constraint corr. to  variable in primal problem           *
*************************************************************************************************
...
v.lo('biomass_mac') = 0.7;
v.up('biomass_mac') = 2.2;
